...
DATA[:post_votes] = YAML.safe_load File.read('app/db/seeds/post_votes_seed.yml')
DATA[:comments] = YAML.safe_load File.read('app/db/seeds/comments_seed.yml')
DATA[:comment_votes] = YAML.safe_load File.read('app/db/seeds/comment_votes_seed.yml')